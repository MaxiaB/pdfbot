...
def main():
    ...
    pdf = st.file_uploader(
        "Upload a PDF file with text in English. PDFs that only contain images will not be recognized.",
        type=["pdf"],
    )
    ...
    try:
        ...
        if pdf is None:
            ...
            st.error(str(e))
            st.write(
                f"You have encountered an error. Please give {str(e)} as feedback to the developer."
            )
